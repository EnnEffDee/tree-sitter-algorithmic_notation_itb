LANGUAGE_NAME := tree-sitter-algorithmic-notation-itb
HOMEPAGE_URL := https://github.com/tree-sitter/tree-sitter-algorithmic_notation_itb
VERSION := 0.1.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/algorithmic-notation-itb '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/algorithmic-notation-itb
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/algorithmic-notation-itb
